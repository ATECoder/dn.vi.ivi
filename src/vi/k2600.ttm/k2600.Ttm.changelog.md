...
* Add legacy driver. 
* Add TTM, Driver and Letgacy Driver unit tests.
* Add firmware outcome for open leads and measuerment failed to the measurement outcome parser.
...
[8.1.9082]: https://www.bitbucket.org/davidhary/dn.vi.core
