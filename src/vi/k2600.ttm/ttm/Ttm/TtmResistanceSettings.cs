...
public partial class TtmResistanceSettings : CommunityToolkit.Mvvm.ComponentModel.ObservableObject
{
    #region " construction "
    ...
    public partial double ApertureDefault { get; set; } = 1;
    ...
    public partial double CurrentLevelDefault { get; set; } = 0.01;
    ...
    public partial double CurrentLimitDefault { get; set; } = 0.01;
    ...
    public partial int FailStatusDefault { get; set; } = 2;
    ...
    public partial double HighLimitDefault { get; set; } = 2.156;
    ...
    public partial double LowLimitDefault { get; set; } = 1.85;
    ...
    public partial double VoltageLevelDefault { get; set; } = 0.1;
    ...
    public partial double VoltageLimitDefault { get; set; } = 0.1;
