...
public class ResistanceSettings() : System.ComponentModel.INotifyPropertyChanged
{
    ...
    {
        AppSettingsScribe.ReadSettings( Tests.Settings.AllSettings.Instance.Scribe!.AllUsersSettingsPath!, nameof( ResistanceSettings ),
            Tests.Settings.AllSettings.Instance.ResistanceSettings,
