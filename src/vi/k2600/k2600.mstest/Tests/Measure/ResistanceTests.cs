...
public class ResistanceTests : Device.Tsp.Tests.Base.TestBase
{
    ...
    public override void InitializeBeforeEachTest()
    {
        ...
        this.ResourceSettings = Tests.Settings.AllSettings.Instance.ResourceSettings;
        this.LocationSettings = Tests.Settings.AllSettings.Instance.LocationSettings;
    ...
    public void SourceFunctionShouldApply()
    {
        try
        {
            ...
            try
            {
                VI.Device.Tsp.Tests.Asserts.AssertSourceFunctionShouldApply( this.Device?.SourceSubsystem, Tests.Settings.AllSettings.Instance.SourceResistanceSettings.SourceFunction );
