...
/// <summary> A TSP script Test settings. </summary>
/// <remarks> <para>
/// David, 2018-02-12 </para></remarks>
public class TspScriptSettings() : System.ComponentModel.INotifyPropertyChanged
{
    ...
    /// <summary>   Gets or sets the time to wait for before reading the call function result. </summary>
    /// <value> The time to wait for before reading the call function result. </value>
    [System.ComponentModel.Description( "The time to wait for before reading the call function result [0.4s]" )]
    public System.TimeSpan CallFunctionResultDelay
    {
        get;
