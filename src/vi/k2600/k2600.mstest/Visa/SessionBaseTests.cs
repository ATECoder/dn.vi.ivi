...
[TestClass]
[TestCategory( "k2600" )]
public class SessionBaseTests : Device.Tests.Base.SessionBaseTests
{
    ...
    {
        VI.Device.Tests.Base.SessionBaseTests.InitializeBaseTestClass( testContext );
    }
    ...
    {
        VI.Device.Tests.Base.SessionBaseTests.CleanupBaseTestClass();
    }
