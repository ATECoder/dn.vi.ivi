...
public class AllSettings
{
    ...
    {
        AppSettingsScribe scribe = new( [this.TestSiteSettings, this.BufferStreamViewSettings, this.DigitalOutputViewSettings], settingsFileInfo );
    ...
    public bool SettingsExist( out string settingsClassName )
    {
        ...
        else if ( this.BufferStreamViewSettings is null || !this.BufferStreamViewSettings.Exists )
            settingsClassName = $"{nameof( AllSettings.BufferStreamViewSettings )}";
        else if ( this.DigitalOutputViewSettings is null || !this.DigitalOutputViewSettings.Exists )
            settingsClassName = $"{nameof( AllSettings.DigitalOutputViewSettings )}";
        else
