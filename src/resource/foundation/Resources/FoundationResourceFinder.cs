        ...
        catch ( MissingMethodException ex )
        {
            if ( Ivi.Visa.GlobalResourceManager.ImplementationVersion < new Version( cc.isr.Visa.Gac.GacLoader.IviVisaAssemblyInfo.ImplementationVersion ) )
                throw new InvalidOperationException(
                    $"Failed {activity}; Expecting {cc.isr.Visa.Gac.GacLoader.IviVisaAssemblyInfo.ImplementationVersion} implementation and {cc.isr.Visa.Gac.GacLoader.IviVisaAssemblyInfo.SpecificationVersion} specification versions.", ex );
            else
