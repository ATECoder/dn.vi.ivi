...
/// </remarks>
[CLSCompliant( false )]
public class NativeError : Pith.NativeErrorBase
{
    /// <summary> Constructor. </summary>
    /// <param name="errorCode"> The error code. </param>
    public NativeError( int errorCode ) : base( errorCode ) => this.InitErrorCode( errorCode );
    ...
    private void InitErrorCode( int errorCode )
    {
        try
        {
            this.ErrorCodeName = Ivi.Visa.NativeErrorCode.GetMacroNameFromStatusCode( errorCode );
        }
        catch ( Exception ex )
        {
    ...
    public NativeError( int errorCode, string? resourceName, string? lastMessageSent, string? lastAction )
    ...
    /// <param name="lastMessageSent"> The last message sent. </param>
    /// <param name="lastAction">      The last action. </param>
    public NativeError( int errorCode, string? resourceName, int nodeNumber, string? lastMessageSent, string? lastAction )
