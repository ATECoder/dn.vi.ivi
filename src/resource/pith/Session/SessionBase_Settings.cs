...
public partial class SessionBase
{
    ...
    public void ReadSettings( Type declaringType, string settingsFileSuffix = ".Session", bool overwriteAllUsersFile = false, bool overwriteThisUserFile = false )
    {
        this.AllSettings.ReadSettings( declaringType, settingsFileSuffix, overwriteAllUsersFile, overwriteThisUserFile );
