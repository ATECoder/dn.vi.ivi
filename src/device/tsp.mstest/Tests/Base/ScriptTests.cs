...
namespace cc.isr.VI.Device.Tsp.Tests.Base;
...
public abstract class ScriptTests
{
    ...
    public LoggerTraceListener<ScriptTests>? TraceListener { get; set; }
    ...
    {
        if ( ScriptTests.Logger is not null && this.TraceListener is null )
        {
            this._loggerScope = Logger.BeginScope( this.TestContext?.TestName ?? string.Empty );
            this.TraceListener = new LoggerTraceListener<ScriptTests>( ScriptTests.Logger );
    ...
    public static ILogger<ScriptTests>? Logger { get; } = LoggerProvider.CreateLogger<ScriptTests>();
