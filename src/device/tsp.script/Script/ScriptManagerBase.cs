...
public abstract class ScriptManagerBase( Tsp.StatusSubsystemBase statusSubsystem ) : SubsystemBase( statusSubsystem )
{
    ...
    /// <summary>   Embeds the user scripts applying the release scriptName. </summary>
    /// <remarks>   2024-09-05. </remarks>
    /// <param name="displaySubsystem"> A reference to a
    ///                                 <see cref="VI.Tsp.DisplaySubsystemBase">display
    ///                                 subsystem</see>. </param>
    /// <param name="accessSubsystem">  The access subsystem. </param>
    /// <returns>   <c>true</c> if okay; otherwise, <c>false</c>. </returns>
    public virtual (bool Success, string Details) EmbedUserScripts( DisplaySubsystemBase displaySubsystem, AccessSubsystemBase accessSubsystem )
    { return (false, string.Empty); }
    ...
    /// <param name="accessSubsystem">  The access subsystem. </param>
    /// <returns>   <c>true</c> if okay; otherwise, <c>false</c>. </returns>
    [Obsolete( "Use EmbedUserScripts( displaySubsystem, accessSubsystem, embedTimeout) )" )]
    public virtual bool EmbedUserScripts( TimeSpan timeout, StatusSubsystemBase statusSubsystem, DisplaySubsystemBase displaySubsystem, AccessSubsystemBase accessSubsystem )
    {
        return false;
    }
