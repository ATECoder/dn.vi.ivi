...
public sealed partial class Asserts
{
    ...
    public static void AssertDeviceErrorsShouldRead( VisaSessionBase? device, DeviceErrorsSettings? deviceErrorSettings )
    {
        ...
        Assert.IsTrue( (value & ( int ) expectedServiceRequest) == ( int ) expectedServiceRequest,
        ...
        Assert.IsTrue( (actualServiceRequest & expectedServiceRequest) == expectedServiceRequest,
