...
public abstract class DeviceTests
{
    ...
    {
        if ( DeviceTests.Logger is not null && this.TraceListener is null )
        {
            this._loggerScope = Logger.BeginScope( this.TestContext?.TestName ?? string.Empty );
            this.TraceListener = new LoggerTraceListener<DeviceTests>( DeviceTests.Logger );
    ...
    public void SessionShouldCollectGarbage()
    {
        ...
        {
            Asserts.AssertDeviceShouldOpenWithoutDeviceErrors( this.VisaSessionBase, this.ResourceSettings );
            Asserts.AssertSessionShouldCollectGarbage( this.VisaSessionBase.Session );
        }
        catch
        {
            throw;
