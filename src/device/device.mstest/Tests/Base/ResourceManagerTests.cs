...
public abstract class ResourceManagerTests
{
    ...
    {
        if ( ResourceManagerTests.Logger is not null && this.TraceListener is null )
        {
            this._loggerScope = Logger.BeginScope( this.TestContext?.TestName ?? string.Empty );
            this.TraceListener = new LoggerTraceListener<ResourceManagerTests>( ResourceManagerTests.Logger );
