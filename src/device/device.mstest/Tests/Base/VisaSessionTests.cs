...
public abstract class VisaSessionTests
{
    ...
    {
        if ( VisaSessionTests.Logger is not null && this.TraceListener is null )
        {
            this._loggerScope = Logger.BeginScope( this.TestContext?.TestName ?? string.Empty );
            this.TraceListener = new LoggerTraceListener<VisaSessionTests>( VisaSessionTests.Logger );
    ...
    public void ResourceNameShouldBeFound()
    {
        ...
        session.Session.ReadSettings( this.GetType(), ".Session", true, true );
    ...
    [TestMethod( DisplayName = "03. Trace message should be queued" )]
    ...
    /// <remarks>   David, 2021-07-04. </remarks>
    [TestMethod( DisplayName = "04. Visa session should open" )]
    ...
    [TestMethod( DisplayName = "05. Visa session should clear execution state" )]
    ...
    /// <remarks>   David, 2021-07-04. </remarks>
    [TestMethod( DisplayName = "06. Visa session should wait for status bitmask" )]
    ...
    /// <remarks>   David, 2021-07-04. </remarks>
    [TestMethod( DisplayName = "07. Session should wait for operation completion" )]
    ...
    /// </remarks>
    [TestMethod( DisplayName = "08. Visa session should wait for the Message Available bitmask" )]
    ...
    /// DMM2002 status Byte 0x50 0x10 bitmask was Set</para>
    /// </remarks>
    [TestMethod( DisplayName = "09. Clear Execution State should preserve enable bitmasks" )]
    public void ClearExecutionStateShouldPreserveEnableBitmasks()
    {
        Assert.IsNotNull( this.VisaSessionBase );
        Assert.IsNotNull( this.VisaSessionBase.Session );
        Assert.AreEqual( this.VisaSessionBase.Session.StatusClearDistractive, this.VisaSessionBase.Session.AllSettings.ScpiExceptionsSettings.StatusClearDistractive );

        try
        {
            Asserts.AssertVisaSessionShouldOpen( this.VisaSessionBase, this.ResourceSettings );
            Asserts.AssertNakedClsMightClearEnableBitmasks( this.VisaSessionBase.Session,
                this.VisaSessionBase.Session.AllSettings.RegistersBitmasksSettings.StandardEventEnableEventsBitmask,
                this.VisaSessionBase.Session.AllSettings.RegistersBitmasksSettings.ServiceRequestEnableEventsBitmask );
    ...
    [TestMethod( DisplayName = "10. Clear Execution State should preserve completion bitmasks" )]
    public void ClearExecutionStateShouldPreserveCompletionBitmasks()
    {
        ...
        try
        {
            Asserts.AssertVisaSessionShouldOpen( this.VisaSessionBase, this.ResourceSettings );
            Asserts.AssertNakedClsMightClearEnableBitmasks( this.VisaSessionBase.Session,
                this.VisaSessionBase.Session.AllSettings.RegistersBitmasksSettings.StandardEventEnableOperationCompleteBitmask,
                this.VisaSessionBase.Session.AllSettings.RegistersBitmasksSettings.ServiceRequestEnableOperationCompleteBitmask );
