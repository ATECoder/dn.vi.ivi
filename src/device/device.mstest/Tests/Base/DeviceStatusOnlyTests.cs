...
public abstract class DeviceStatusOnlyTests
{
    ...
    {
        if ( DeviceStatusOnlyTests.Logger is not null && this.TraceListener is null )
        {
            this._loggerScope = Logger.BeginScope( this.TestContext?.TestName ?? string.Empty );
            this.TraceListener = new LoggerTraceListener<DeviceStatusOnlyTests>( DeviceStatusOnlyTests.Logger );
