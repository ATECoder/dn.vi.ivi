...
/// <summary> A visa session. </summary>
/// <remarks>
...
public class VisaSession : VisaSessionBase
{
    ...
    /// <summary> Creates a new <see cref="VisaSession"/>. </summary>
    /// <returns> A visa session. </returns>
    public static VisaSession Create()
    {
        try
        {
            return new VisaSession(); ;
        }
        catch
        {
            throw;
    ...
    protected override void ApplyDefaultSyntax()
    {
        ...
        this.Session?.ApplyDefaultSyntax( Syntax.CommandLanguage.Scpi );
    }
