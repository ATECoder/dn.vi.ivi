...
public partial class SubsystemBase
{
    ...
    private Stopwatch ElapsedTimeStopwatch { get; set; }
    ...
    /// <summary> Stops elapsed time stopwatch and updates the elapsed time. </summary>
    public void StopElapsedStopwatch()
    {
        this.ElapsedTime = this.ReadElapsedTime( true );
    }
}
