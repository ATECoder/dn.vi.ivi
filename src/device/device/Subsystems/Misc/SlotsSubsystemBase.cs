...
/// Subsystem</see>. </param>
[CLSCompliant( false )]
public abstract class SlotsSubsystemBase( int maxSlotCount, StatusSubsystemBase statusSubsystem ) : SubsystemBase( statusSubsystem )
{
...
public class SlotCollection : System.Collections.ObjectModel.KeyedCollection<int, SlotSubsystemBase>
{
    ...
    {
        return item is null ? throw new ArgumentNullException( nameof( item ) ) : item.SlotNumber;
    }
}
