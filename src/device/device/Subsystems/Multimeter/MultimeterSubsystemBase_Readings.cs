...
public partial class MultimeterSubsystemBase
{
    #region " reading "
    ...
    protected virtual double? ParseActiveReading( ReadingAmounts readingAmounts )
    {
        ...
        if ( readingAmounts is null || readingAmounts.ActiveReadingType == ReadingElementTypes.None )
        {
            ...
            value = this.PrimaryReading.Value;
            reading = this.PrimaryReading.RawValueReading;
        }
    ...
    /// <returns> A Double? </returns>
    public virtual double? ParseReadingAmounts( string reading )
    {
    ...
    {
        return this.ParsePrimaryReading( this.Session.QueryTrimEnd( this.Session.EmulatedReply, queryCommand )! );
    }
    ...
    {
        return this.ParseReadingAmounts( this.Session.QueryTrimEnd( this.Session.EmulatedReply, queryCommand )! );
    }
