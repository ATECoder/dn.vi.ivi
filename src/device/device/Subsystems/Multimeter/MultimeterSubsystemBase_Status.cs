...
public partial class MultimeterSubsystemBase
{
    ...
    {
        this.NotifyPropertyChanged( nameof( this.FailureLongDescription ) );
        this.NotifyPropertyChanged( nameof( this.FailureShortDescription ) );
        this.NotifyPropertyChanged( nameof( this.FailureCode ) );
    }
