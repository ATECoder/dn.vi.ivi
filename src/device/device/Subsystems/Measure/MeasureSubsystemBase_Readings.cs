...
public partial class MeasureSubsystemBase
{
    ...
    public virtual string FetchReading( string queryCommand )
    {
        return this.Session.QueryTrimEnd( this.Session.EmulatedReply, queryCommand ) ?? this.Session.EmulatedReply;
    }
