...
public class ScriptEntityBaseCollection<TItem>( NodeEntityBase node ) : System.Collections.ObjectModel.KeyedCollection<string, TItem> where TItem : ScriptEntityBase
{
    ...
    {
        return this.IsSaveRequired( session, script.Name, script.FirmwareScript.SaveToNonVolatileMemory, script.FirmwareScript.ConvertToByteCode, script.FirmwareScript.IsBootScript );
    }
