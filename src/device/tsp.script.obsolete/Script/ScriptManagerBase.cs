...
public abstract class ScriptManagerBase( Tsp.StatusSubsystemBase statusSubsystem ) : SubsystemBase( statusSubsystem )
{
    ...
    /// <param name="saveAsByteCode">     True to save the user script as a byte code script to the user
    ...
    public virtual void DefineScripts( bool saveAsByteCode, ScriptFileFormats deployFileFormat = ScriptFileFormats.Compressed, bool readSource = true ) { }
