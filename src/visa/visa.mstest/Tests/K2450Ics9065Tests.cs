...
[TestClass]
[TestCategory( "k2450+Ics9065" )]
public class K2450Ics9065Tests : InstrumentTests
{
    ...
    public override void InitializeBeforeEachTest()
    {
        ...
        Tests.Asserts.AssertVisaImplementationShouldBeLoaded();
        ...
        this.ServiceRequestTestRepeatCount = 2;
