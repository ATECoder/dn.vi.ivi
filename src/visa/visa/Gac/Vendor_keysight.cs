...
public static partial class Vendor
{
    ...
    public const string KEYSIGHT_VISA_PATH = @"C:\Windows\assembly\GAC_MSIL\Keysight.Visa\18.6.0.0__7a01cdb2a9131f73";
    ...
    public const string KEYSIGHT_VISA_FULL_NAME = "Keysight.Visa, Version=18.6.0.0, Culture=neutral, PublicKeyToken=7a01cdb2a9131f73";

    /// <summary>   (Immutable) full name of the Keysight visa resource manager. </summary>
    public const string KEYSIGHT_RESOURCE_MANAGER_TYPE_NAME = "Keysight.Visa.ResourceManager, Keysight.Visa, Version=18.6.0.0, Culture=neutral, PublicKeyToken=7a01cdb2a9131f73";
