...
public static partial class GacLoader
{
    ...
    public static VisaAssemblyInfo KeysightVisaAssemblyInfo => new()
    {
        ...
        FolderPath = @"C:\Program Files\IVI Foundation\VISA\Microsoft.NET\VendorAssemblies\kt\8.0\Keysight.Visa",
    ...
    public static VisaAssemblyInfo NIVisaAssemblyInfo => new()
    {
        ...
        FolderPath = @"C:\Program Files\IVI Foundation\VISA\Microsoft.NET\VendorAssemblies\kt\25.0\NI.Visa",
