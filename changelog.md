...
[8.1.9608]: https://www.github.com/atecoder/dn.vi.ivi

Current IVI Visa Compatibility: 8.0.2.9518

## [8.1.9608] - 2026-04-21
CsStatusSrq:
- Add project from Keysight.
- Modify for IVI>Visa 8.0.2 and .NET 10.
- Test and create a read me file.

## [8.1.9603] - 2026-04-17
IviVisaNetServiceRequest:
- Add IVI Visa info.
- Add wait for events.
- Add event options.
...
- 2600 TTM
  - Driver Settings
    - Fix construction of the settings scribe.
  - Tests
     - Add Meter tests.
...
## [8.1.9574] - 2026-03-19
- TTM.MSTest
  - Rename a few test methods.
  - Meter Settings Test:
    - Update for 4 contact check options.
    - Restore legacy driver option.
...
- Add release notes to the TTM documents

## [8.2.9511] - 2026-01-15
- Session Factory:
  - Call the GAC Loader verify upon construction.
- MS Test
  - Validate Visa at static test class construction.

## [8.1.9508] - 2026-01-12
- K2600.Device
  - Add Status Subsystem disposal.
...
- Add ignore ending to file comparisons and rename methods.
...
- Device Tsp
  - Extensions
    - Convert methods to Try methods with details.

## [8.1.9453] - 2025-11-18
- Transition to .SLNX solution file.
- Overwrite settings if debugging or testing.

## [8.1.9451] - 2025-11-16
- MS Test: Initialize settings files.
- K2600 MSTest
  - Add scripts tests.
  - Add script session tests.

## [8.1.9450] - 2025-11-15
- Transition .NET 9.0 projects to .NET 10 and VS2026.
- Move the list of ISR Visa resources from the protected public documents folder to the application data.
